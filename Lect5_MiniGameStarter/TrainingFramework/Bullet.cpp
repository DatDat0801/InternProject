...
Bullet::Bullet(std::shared_ptr<Model> model, std::shared_ptr<Shader> shader, std::shared_ptr<Texture> texture, float speed) : Sprite2D(model, shader, texture), m_speed(speed),m_isStop(true)
{}
